...
window._checkGmailConvTrigger = async function(msg) {
  ...
  setTimeout(()=>{
    ...
    div.style.cssText='margin:8px 14px;background:linear-gradient(135deg,#faf5ff,#f3ecff);border:1.5px solid #ddd6fe;border-radius:12px;padding:12px 14px;display:flex;align-items:center;gap:10px;cursor:pointer;animation:fadeInUp .3s ease';
    div.onclick=()=>{div.remove();openSidebarSettings();setTimeout(openGmailPanel,350);};
    div.innerHTML=`<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><path d="M20 4H4C2.9 4 2 4.9 2 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" fill="#ea4335" opacity=".2"/><path d="M20 4H4L12 13l8-9z" fill="#ea4335"/></svg><div style="flex:1;min-width:0"><div style="font-size:11px;font-weight:800;color:#7c3aed;margin-bottom:2px">Tip from KIE</div><div style="font-size:12px;color:#374151;line-height:1.45">Connect your Gmail and I can track all of this automatically.</div></div><svg width="12" height="12" fill="none" viewBox="0 0 24 24" stroke="#7c3aed" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>`;
